                ...
                <div className="box-060">
                  <div className="row">
                    ...
                    <div className="col-md-2 col-2 flex-center-end">
                      ...
                      >
                        <i className="ti-angle-right font-24" style={{ cursor: 'pointer' }} />
                      </Link>
                    </div>
                  </div>
                  <div className="note-warning font-18 font-medium mgt-20 text-red flex-center">
                    <img src="images/icon/c-warning.svg" alt="" className="mgr-15" />
                    We're sorry but your address is out of scope, please pick a nearer address
                  </div>
                </div>
              </div>
              {/* payment method */}
